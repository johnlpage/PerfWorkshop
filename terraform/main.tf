...
locals {
  ...
  # IAM role name for MongoDB Atlas IAM authentication
...
# Policy: only allow the role to verify its own identity via STS
# This is the minimum needed for MongoDB Atlas IAM authentication —
# the MongoDB driver calls sts:GetCallerIdentity to prove who it is.
...
# -------------------------------------------------------------------
# EC2 Instance — now with the IAM instance profile attached
# -------------------------------------------------------------------
